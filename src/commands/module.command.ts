...
import { Prompt, QuestionCollection } from '@core/prompt'
...
export class ModuleCommand extends Command {
    ...
    async action(args: any) {
        const templateControl = new TemplateControl('module')
        ...
        const resultGenerateTemplete = templateControl.execute(answers)
    }
}
